...
// Using OpenAI's most capable models
export const OPENAI_MODEL_TEXT = 'gpt-4o'; // GPT-4o - fastest and most capable
...
export const DEFAULT_USER_PROFILE: UserProfile = {
  ...
  voiceOutput: {
    ...
    pitch: 1,
    volume: 1,
    voiceURI: 'onyx', // Default to Onyx (deep, authoritative) - good for trucker assistant
  },
  voiceInput: {
    language: 'en-US',
  },
